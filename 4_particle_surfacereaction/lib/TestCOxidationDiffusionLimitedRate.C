...
#include "TestCOxidationDiffusionLimitedRate.H"
...
Foam::TestCOxidationDiffusionLimitedRate<CloudType>::TestCOxidationDiffusionLimitedRate
(
...
Foam::TestCOxidationDiffusionLimitedRate<CloudType>::TestCOxidationDiffusionLimitedRate
(
    const TestCOxidationDiffusionLimitedRate<CloudType>& srm
)
:
...
template<class CloudType>
Foam::scalar Foam::TestCOxidationDiffusionLimitedRate<CloudType>::calculate
(
    const scalar dt,
    const scalar Re,
    const scalar nu,
